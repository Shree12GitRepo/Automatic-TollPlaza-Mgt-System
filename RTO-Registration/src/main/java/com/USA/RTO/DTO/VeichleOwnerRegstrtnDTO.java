...
public class VeichleOwnerRegstrtnDTO {
	...
	public String toString() {
		return "VeichleOwnerRegstrtnDTO [owner_Fname=" + owner_Fname + ", owner_Lname=" + owner_Lname + ", owner_email="
				+ owner_email + ", owner_Mob=" + owner_Mob + ", owner_DOB=" + owner_DOB + ", owner_Gender="
				+ owner_Gender + "]";
	}
}
